...
import com.groupfive.OnlineMovieTicketBooking.services.BookingService;
...
public class BookingController {
    ...
    @GetMapping
    public ResponseEntity<?> listall(Optional<Integer> customerid){
    	if(customerid.isPresent())
    		return ResponseEntity.ok(service.allcustomerbooking(customerid.get()));
